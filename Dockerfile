...
# 3. Installer la version exacte de Chromedriver compatible avec Chrome 138
RUN echo "=== [DEBUG] Installation de Chromedriver 138.0.7204.92 ===" && \
    rm -f /usr/local/bin/chromedriver && \
    wget -O /tmp/chromedriver.zip "https://chromedriver.storage.googleapis.com/138.0.7204.92/chromedriver_linux64.zip" && \
